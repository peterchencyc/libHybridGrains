...
# Thesis: Periodic
# img_size = numpy.array([1920, 1080])
# cmra_psn = numpy.array([0.0, 8.1])
# cmra_scl = 9.7
# render_headers = False
# render_background = True

# Thesis: Small funnel drain zoom in
# img_size = numpy.array([1920, 1080])
# cmra_psn = numpy.array([0.0, 19.0])
# cmra_scl = 9.0
# render_headers = False
# render_background = True
...
def draw_config(input_hdf5_name, output_image_name, image_size, camera_psn, camera_scl):
    ...
    for bdy_idx in range(0, mstate.npoints):
        # circle_colors.append([0., 0., 0., 0.5])
        # circle_colors.append([0., 0., 0., 1.0])
        # circle_colors.append(numpy.array([230., 41., 50., 255.]) / 255.) # Salmon
        circle_colors.append(1.0 * numpy.array([227., 148., 174.]) / 255.) # Pink
    ...
    with rb2d_rendering.CairoImage(output_image_name, image_size) as cr:
        ...
        rb2d_rendering.render_circles(cr, image_size, camera_psn, camera_scl, mstate.q, circle_colors, 0.06)
