...
// TODO: Actually check that infinity and not-a-number are supported by selected
// type
#define SCALAR_INFINITY std::numeric_limits<scalar>::infinity()
#define SCALAR_NAN std::numeric_limits<scalar>::signaling_NaN()

// TODO: Some of these are incosistent with others (e.g. MatrixXs vs
// Matrix3Xic), fix that
...
using Vector9s = Eigen::Matrix<scalar, 9, 1>;
...
// TODO: Clean this up :)
// Define scalar-valued versions of the Eigen matrix types. r postfix denotes
// row-major, c postfix denotes column-major.
...
using Matrix4Xsc = Eigen::Matrix<scalar, 4, Eigen::Dynamic, Eigen::ColMajor>;
