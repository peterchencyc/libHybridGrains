...
Vector3s CollisionDetectionUtilities::computeCCDQuadraticCoeffs(
    const Vector2s &q0a, const Vector2s &q1a, const scalar &ra,
    const Vector2s &q0b, const Vector2s &q1b, const scalar &rb) {
  Vector3s coeffs;
...
static scalar firstRootOfQuadratic(const scalar &a, const scalar &b,
...
CollisionDetectionUtilities::ballBallCCDCollisionHappens(const Vector3s &c) {
...
CollisionDetectionUtilities::ballBallCCDCollisionHappens(
    const Vector2s &q0a, const Vector2s &q1a, const scalar &ra,
    const Vector2s &q0b, const Vector2s &q1b, const scalar &rb) {
  return ballBallCCDCollisionHappens(
      computeCCDQuadraticCoeffs(q0a, q1a, ra, q0b, q1b, rb));
}
