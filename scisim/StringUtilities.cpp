...
void StringUtilities::serializeString(const std::string &input_string,
                                      std::ostream &stm) {
  assert(stm.good());
...
void StringUtilities::splitAtLastCharacterOccurence(
    const std::string &input_string, std::string &left_substring,
    std::string &right_substring, const char chr) {
...
StringUtilities::computeNumCharactersToRight(const std::string &input_string,
                                             const char chr) {
...
std::string StringUtilities::trimFront(const std::string &input_string) {
  ...
  output_string.erase(
      output_string.begin(),
      std::find_if(output_string.begin(), output_string.end(),
...
std::string StringUtilities::trimBack(const std::string &input_string) {
  std::string output_string = input_string;
  output_string.erase(
      std::find_if(output_string.rbegin(), output_string.rend(),
                   [](const char x) { return !std::isspace(x); })
          .base(),
      output_string.end());
  return output_string;
...
std::string StringUtilities::removeWhiteSpace(const std::string &input_string) {
  std::string output_string = input_string;
  output_string.erase(
      std::remove_if(output_string.begin(), output_string.end(),
                     [](const char x) { return std::isspace(x); }),
      output_string.end());
  return output_string;
}

std::string StringUtilities::trimCharacterRight(const std::string &input_string,
                                                const char chr) {
  return input_string.substr(0, input_string.find_last_not_of(chr) + 1);
}

std::string StringUtilities::padWithZeros(const std::string &input_string,
...
void StringUtilities::tokenize(const std::string &str, const char chr,
...
std::vector<std::string> StringUtilities::tokenize(const std::string &str,
