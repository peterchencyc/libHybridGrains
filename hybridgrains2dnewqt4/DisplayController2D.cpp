...
DisplayController2D::DisplayController2D()
    : m_window_width(512), m_window_height(512), m_scale_factor(1.0),
...
void DisplayController2D::translateView(const GLdouble &dx,
                                        const GLdouble &dy) {
  const GLdouble translate_x{2.0 * m_scale_factor * dx /
                             GLdouble(m_window_height)};
  const GLdouble translate_y{2.0 * m_scale_factor * dy /
                             GLdouble(m_window_height)};
...
unsigned DisplayController2D::width() const { return m_window_width; }

unsigned DisplayController2D::height() const { return m_window_height; }

const GLdouble &DisplayController2D::scaleFactor() const {
  return m_scale_factor;
}

const GLdouble &DisplayController2D::centerX() const { return m_center_x; }

const GLdouble &DisplayController2D::centerY() const { return m_center_y; }
