...
, m_content_widget( nullptr )
{
  ...
  // Print the simulation state to the terminal
  QAction* export_sim_state{ new QAction{ tr( "Export State..." ), this } };
  file->addAction( export_sim_state );
  connect( export_sim_state, SIGNAL( triggered() ), m_content_widget, SLOT( exportSimState() ) );
