#ifndef LINEAR_BASIS_FUNCTIONS_H
#define LINEAR_BASIS_FUNCTIONS_H

#include "BasisFunctions.h"

struct LinearBasisFunctions final : public BasisFunctions {

  LinearBasisFunctions() = default;

  virtual ~LinearBasisFunctions() override = default;
