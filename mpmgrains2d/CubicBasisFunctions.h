#ifndef CUBIC_BASIS_FUNCTIONS_H
#define CUBIC_BASIS_FUNCTIONS_H

#include "BasisFunctions.h"

struct ThirdOrderBasisFunctions final : public BasisFunctions {

  ThirdOrderBasisFunctions() = default;

  virtual ~ThirdOrderBasisFunctions() override = default;
