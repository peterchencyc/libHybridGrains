...
RigidBody2DStaticPlane::RigidBody2DStaticPlane(const Vector2s &x,
                                               const Vector2s &n)
    : m_x(x), m_n(n), m_t(-n.y(), n.x()), m_v(Vector2s::Zero()), m_omega(0.0) {
...
const Vector2s &RigidBody2DStaticPlane::x() const { return m_x; }

const Vector2s &RigidBody2DStaticPlane::n() const { return m_n; }

const Vector2s &RigidBody2DStaticPlane::t() const { return m_t; }

const Vector2s &RigidBody2DStaticPlane::v() const { return m_v; }

const scalar &RigidBody2DStaticPlane::omega() const { return m_omega; }

void RigidBody2DStaticPlane::setX(const Vector2s &x) { m_x = x; }
...
void RigidBody2DStaticPlane::setV(const Vector2s &v) { m_v = v; }

void RigidBody2DStaticPlane::setOmega(const scalar &omega) { m_omega = omega; }
