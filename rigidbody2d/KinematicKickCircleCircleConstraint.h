...
class KinematicKickCircleCircleConstraint final
    : public TeleportedCircleCircleConstraint {

public:
  KinematicKickCircleCircleConstraint(const unsigned idx0, const unsigned idx1,
