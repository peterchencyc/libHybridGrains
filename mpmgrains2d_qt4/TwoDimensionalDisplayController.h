// TODO: Give this class a more sensible name

#ifndef TWO_DIMENSIONAL_DISPLAY_CONTROLLER_H
#define TWO_DIMENSIONAL_DISPLAY_CONTROLLER_H
...
class TwoDimensionalDisplayController final
{

public:

  TwoDimensionalDisplayController();
